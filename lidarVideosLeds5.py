...
def play_video(video):
    fps = video.get(cv2.CAP_PROP_FPS)  # Obtener los FPS del video
    if fps == 0:  # Si FPS no es válido, se asigna un valor por defecto (30 FPS)
        fps = 30
    ...
    # Tiempo de espera entre frames para asegurar la velocidad correcta
    time.sleep(1 / fps)
    return True
